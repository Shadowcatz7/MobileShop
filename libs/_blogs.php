...
<section id="blogs">
    <div class="container py-4">
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="card border-1 me-5">
                    <h5 class="card-title font-size-16 text-dark text-center mt-1">Rò rỉ thông tin Samsung Galaxy Note 20</h5>
                    <img src="./assets/blog/blog4.jpg" class="card-img-top">
                    <p class="card-text font-size-14 text-black-50 px-2">Ở thời điểm hiện tại, dù không thực sự chi tiết nhưng các tin đồn xuất hiện trong thời gian vừa qua đã cung cấp cho chúng ta</p>
                    <a href="#" class="color-second text-start ps-2 mb-2">Xem ngay</a>
                </div>
            </div>
            ...
            <div class="item">
                <div class="card border-1 me-5">
                    <h5 class="card-title font-size-16 text-dark text-center mt-1">IphoneXS-Chiếc smartphone độc đáo nhất</h5>
                    <img src="./assets/blog/blog5.jpg" class="card-img-top">
                    <p class="card-text font-size-14 text-black-50 px-3">Thiết kế màn hình IphoneXS xứng đáng là smartphone cao cấp
                        Điện thoại IphoneXS nổi bật với màu “Gradient” vốn đã được sử dụng trên IphoneXS, được lấy cảm hứng từ xu hướng sử dụng bản màu </p>
                    <a href="#" class="color-second text-start ps-2 mb-2">Xem ngay</a>
                </div>
            </div>
